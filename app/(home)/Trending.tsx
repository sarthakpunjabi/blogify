...
const TredingCard = ({ className } : TrendingCardProps) => {
    return (
        <Link
  ...
  return (
    <section className='pt-3 pb-10'>
        ...
        <div className="sm:grid gap-5 grid-cols-4 grid-rows-2 sm:h-[600px] my-3">
            <TredingCard className="col-span-2 row-span-2 bg-wh-500" />
            <TredingCard className="col-span-2 row-span-1 bg-wh-500" />
            <TredingCard className="col-span-1 row-span-1 bg-wh-500" />
            <TredingCard className="col-span-1 row-span-1 bg-wh-500" />
        </div>
